            ...
            with self._graph.as_default():
                ...
                if validate:
                    ...
                    if num_samples > 0:
                        ...
                        episode_logs['est_value'] = self._model.predict_on_batch(x)
                        episode_logs['est_value'] = episode_logs['est_value'].sum() / num_samples
                        episode_logs['true_value'] = y['quality_output'].sum() / num_samples
